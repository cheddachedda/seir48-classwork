...
describe Bank do
  ...
  describe '.new' do
    ...
    it 'assigns a bank with a name' do
  ...
  describe '#withdraw' do
    it 'withdraws an amount from a particular account' do
      bank.create_account 'Mad Robbie', 1000
      bank.withdraw 'Mad Robbie', 800
      expect(bank.accounts['Mad Robbie']).to eq 200
    end
  ...
  describe '#balance' do
    it 'returns the balance of a particular account' do
      bank.create_account 'Xavier', 5000
      balance = bank.balance 'Xavier'
